...
const StatusCount = ({ count, isLoading }) => {
  ...
  return (
    <div className="my-6">
      <div className="text-lg font-semibold my-4">My Book Request Summary</div>
      <div className="flex items-center flex-wrap gap-4">
        ...
        <DashCard title="Failed to Return" data={failed} icon={<CircleX className="text-orange-500" />} />
      </div>
