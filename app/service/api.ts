...
export const addStudents = async (params: IRegisterParams): Promise<IApiResponse<IStudent>> => {
  return await post<IStudent>("/api/admin/addAdmin", params);
};

export const deleteStudent = async (params: { id: string }): Promise<IApiResponse<void>> => {
  return await post<void>("/api/admin/deleteStudent", params);
};

export const editStudent = async (params: FormData | IServiceParams, hasFormData: boolean = false): Promise<IApiResponse<IStudent>> => {
  return await post<IStudent>("/api/admin/editAdmin", params, hasFormData);
};

export const getBooks = async (params: IServiceParams = {}): Promise<IApiResponse<IBook[]>> => {
  return await post<IBook[]>("/api/book", params);
};

export const addBook = async (params: FormData | IServiceParams, hasFormData: boolean = false): Promise<IApiResponse<IBook>> => {
  return await post<IBook>("/api/book/addBook", params, hasFormData);
};

export const deleteBook = async (params: { id: string }): Promise<IApiResponse<void>> => {
  return await post<void>("/api/book/deleteBook", params);
};

export const updateBook = async (params: FormData | IServiceParams, hasFormData: boolean = false): Promise<IApiResponse<IBook>> => {
...
export const requestBook = async (params: IRequestBookParams): Promise<IApiResponse<void>> => {
...
export const getAnnouncement = async (params: IServiceParams = {}): Promise<IApiResponse<IAnnouncement[]>> => {
  return await post<IAnnouncement[]>("/api/announcement", params);
};

export const addAnnouncement = async (params: IAnnouncementParams): Promise<IApiResponse<IAnnouncement>> => {
  return await post<IAnnouncement>("/api/announcement/addAnnouncement", params);
};

export const deleteAnnouncement = async (params: { id: string }): Promise<IApiResponse<void>> => {
  return await post<void>("/api/announcement/deleteAnnouncement", params);
};

export const updateAnnouncement = async (params: IAnnouncementParams & { id: string }): Promise<IApiResponse<IAnnouncement>> => {
  return await post<IAnnouncement>("/api/announcement/updateAnnouncement", params);
};

export const getNotification = async (params: IServiceParams = {}): Promise<IApiResponse<INotification[]>> => {
  return await post<INotification[]>("/api/notification", params);
};

export const notificationItem = async (params: { id: string }): Promise<IApiResponse<INotification>> => {
  return await post<INotification>("/api/notification/getNotif", params);
};

export const readNotification = async (params: { id: string }): Promise<IApiResponse<void>> => {
  return await post<void>("/api/notification/readNotification", params);
};

export const addNotification = async (params: INotificationParams): Promise<IApiResponse<INotification>> => {
  return await post<INotification>("/api/notification/addNotification", params);
};

export const updateMonthlyBorrowedBooksStats = async (params: IServiceParams): Promise<IApiResponse<void>> => {
  return await post<void>("/api/adminGraphs", params);
};

export const getMonthlyBorrowedBooksStats = async (params: IServiceParams = {}): Promise<IApiResponse<any>> => {
  return await post("/api/adminGraphs/getAdminGraphs", params);
};

export const updateQuantity = async (params: { id: string; quantity: number }): Promise<IApiResponse<void>> => {
  return await post<void>("/api/book/reduceQuantityBook", params);
};

export const updateWeeklyBookStats = async (params: IServiceParams): Promise<IApiResponse<void>> => {
  return await post<void>("/api/book/weeklyStats/updateWeeklyStats", params);
};

export const weeklyBookStats = async (params: IServiceParams = {}): Promise<IApiResponse<any>> => {
  return await post("/api/book/weeklyStats", params);
};

export const changePassword = async (params: IChangePasswordParams): Promise<IApiResponse<IStudent>> => {
